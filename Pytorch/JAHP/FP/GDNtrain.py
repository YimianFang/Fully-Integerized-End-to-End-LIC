...
from FP.GDNmodel import JointAutoregressiveHierarchicalPriors
...
def save_checkpoint(state, is_best, filename="checkpoint.pth.tar"):
    filename = os.path.join("FP/checkpoints", filename)
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, os.path.join("FP/checkpoints", "checkpoint_best_loss.pth.tar"))
...
def main(argv):
    ...
    net = JointAutoregressiveHierarchicalPriors()
    net = net.to(device)
