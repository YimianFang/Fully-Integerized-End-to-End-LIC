...
def main():
    ...
    muls_m = {"h_s":[25, 25, 25], "h_a":[22, 23, 25], 
                "g_s":[23, 23, 24, 28], "g_a":[16, 25, 24, 23],
    ...
    act_Bits = 8 #####
    train_lambda = 115.37 #####
    loadFP = False ##### False -- preiter True -- "checkpoint_best_loss.pth.tar"
    preiter = 2 #####
    lr = 1e-5 ##### 1e-5 1e-6 1e-7 (Adam)
    aux_lr = lr * 0.1
    optim_Adam = True #####
    save_path = "pre_int32/checkpoints/msssim_" + str(train_lambda) + "/" #####
    ...
    global model_dir
    model_dir = "pre_int32/checkpoints/msssim_" + str(train_lambda)
