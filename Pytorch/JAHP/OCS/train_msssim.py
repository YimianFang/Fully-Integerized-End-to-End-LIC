...
def parse_args(argv):
    ...
    parser.add_argument("--ga-left", type=int, default=3)
    parser.add_argument("--hs-left", type=int, default=2)
    parser.add_argument("--en-left", type=int, default=3)
...
def main(argv):
    ...
    model_dir = "OCS/checkpoints/msssim_" + str(args.lmbda)
