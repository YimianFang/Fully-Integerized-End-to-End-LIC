...
class ImageCompressor(nn.Module):
    ...
    def forward(self, input_image):
        ...
        mulsE = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_muls_Encoder.pth.tar", map_location=device)
        relusE = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_relus_Encoder.pth.tar", map_location=device)
        ...
        mulspE = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_muls_priorEncoder.pth.tar", map_location=device)
        reluspE = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_relus_priorEncoder.pth.tar", map_location=device)
        ...
        mulspD = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_muls_priorDecoder.pth.tar", map_location=device)
        reluspD = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_relus_priorDecoder.pth.tar", map_location=device)
        ...
        mulsD = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_muls_Decoder.pth.tar", map_location=device)
        relusD = torch.load("/data1/fym/pre_int32/checkpoints/qft_2048_eq/iter_51010_relus_Decoder.pth.tar", map_location=device)
