...
class Synthesis_prior_net(nn.Module):
    ...
    def __init__(self, out_channel_N=192, out_channel_M=320):
        ...
        self.deconv1 = nn.Conv2d(out_channel_N, out_channel_N, 5, stride=1)
        ...
        self.deconv3 = nn.Conv2d(out_channel_N, out_channel_M, 3, stride=1)
    ...
    def forward(self, x):
        ...
        x = add_zeros2(x, kernel=3, stride=1, padding=1, output_padding=0)
        x = self.deconv3(x)
