...
class ImageCompressor(nn.Module):
    ...
    def forward(self, input_image):
        ...
        mulsE = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_muls_Encoder.pth.tar", map_location=device)
        relusE = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_relus_Encoder.pth.tar", map_location=device)
        ...
        mulspE = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_muls_priorEncoder.pth.tar", map_location=device)
        reluspE = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_relus_priorEncoder.pth.tar", map_location=device)
        ...
        mulspD = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_muls_priorDecoder.pth.tar", map_location=device)
        reluspD = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_relus_priorDecoder.pth.tar", map_location=device)
        ...
        mulsD = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_muls_Decoder.pth.tar", map_location=device)
        relusD = torch.load("/data/fym/pre_int32/checkpoints/qft_512_w12/iter_453460_relus_Decoder.pth.tar", map_location=device)
